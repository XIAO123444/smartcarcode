...
//    ips200_show_int(0,280,carstatus_now,1);
    ...
    centerline2_change();
    Find_Down_Point(MT9V03X_H-1, 5); // 查找下半段边界点
    Find_Up_Point(5, MT9V03X_H-1);   // 查找上半段边界点
...
//		//十字路口↓↓↓↓↓↓↓↓
//        // 十字路口检测条件：左右边界均不连续
//        if(continuity_left(search_stop, MT9V03X_H-5)   >0  && 
//           continuity_right(search_stop, MT9V03X_H-5) > 0 ) 
//        {
//            
//            // 查找边界突变点（从上往下扫描）
//            
